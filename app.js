...
(function() {
    ...
    let rulerScaleSlider, rulerScaleValue, rulerResetBtn;
    // Collaboration elements
    let collabBtn, collabModal, closeCollabModal, collabStatus;
    let hostTabBtn, joinTabBtn, hostTab, joinTab;
    let hostPassphrase, createOfferBtn, offerOutput, offerBlob, copyOfferBtn;
    let answerInput, answerBlobInput, applyAnswerBtn;
    let joinPassphrase, offerBlobInput, createAnswerBtn;
    let answerOutput, answerBlob, copyAnswerBtn;
    ...
    function init() {
        ...
        // Collaboration elements (may not exist)
